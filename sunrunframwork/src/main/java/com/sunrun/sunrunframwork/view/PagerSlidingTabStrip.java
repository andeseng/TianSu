...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFF96262;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setBackgroundColor(Color.TRANSPARENT); //解决手机适配问题
        ...
        tabTextColor=a.getColor(R.styleable.PagerSlidingTabStrip_unselectedTabTextColor,tabTextColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft + getIndicatorPaddingLeft(), height - indicatorHeight, lineRight - getIndicatorPaddingRight(), height, rectPaint);
    ...
    public void setTextSize(int textSizePx) {
        this.tabTextSize = DisplayUtil.sp2px(context, textSizePx);
        updateTabStyles();
    }
