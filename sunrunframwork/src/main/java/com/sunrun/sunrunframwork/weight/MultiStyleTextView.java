...
public static class     StyleTextBuilder {
    ...
    public static String Size(String txt,int sizeSp){
        return String.format("//s%d%s//s!/ ",sizeSp,txt);
    }
    public static String Color(String txt,int color){
        return String.format("//#%d%s//#!/ ",Integer.toHexString(color),txt);
    }
    ...
    public StyleTextBuilder append(String txt){
