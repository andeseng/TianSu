...
public class TitleBar extends FrameLayout {
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        int defaultTextColor = context.getResources().getColor(R.color.text2);
        ...
        final int titleTexttSize = att.getInteger(R.styleable.TitleBar_titleSize,DEFAUT_TEXT_SIZE);//默认是16的大小
        ...
        setTitle(titleText, titleColor,titleTexttSize);
    ...
    public TitleBar setTitle(@NonNull String title) {
        return setTitle(title, Color.TRANSPARENT,DEFAUT_TEXT_SIZE);
    }

    public TitleBar setTitle(String title, @ColorInt int textColor,int titleTexttSize) {
        if (textColor != Color.TRANSPARENT) {
            this.txtTitle.setTextColor(textColor);
        }
        this.txtTitle.setTextSize(titleTexttSize);
